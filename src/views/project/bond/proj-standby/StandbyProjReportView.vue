 ...
 * @LastEditors: g05047
 * @LastEditTime: 2023-10-27 10:47:13
 * @Description: 备选项目上报
-->
    ...
    <template #header_right>
      ...
      <template v-if="queryParams.wfStatus==='002'">
        <el-button type="danger"
          @click="handleOperation('cancle','撤销上报', 1)">撤销上报</el-button>
      </template>
...
const tableColumns = ref([
  ...
  { field: 'sortId', title: '重点项目排序号', width: 150, align: 'center', visible: queryParams.nodeId === 'node_5' ? true : false },
  {
    field: 'proName',
    title: '项目名称',
    width: 250,
