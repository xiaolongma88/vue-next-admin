<template>
  <div class="panel-tab__content">
    <el-table :data="elementListenersList" border height="200" style="width: 100%">
      <el-table-column label="序号" width="100px" type="index" />
      <el-table-column label="事件类型" width="100px" show-overflow-tooltip :formatter="row => listenerEventTypeObject[row.event]" />
      <el-table-column label="事件id" width="80px" prop="id" show-overflow-tooltip />
      <el-table-column label="监听器类型" width="100px" show-overflow-tooltip :formatter="row => listenerTypeObject[row.listenerType]" />
    ...
    <!-- 监听器 编辑/创建 部分 -->
    <el-drawer v-model="listenerFormModelVisible" title="任务监听器" append-to-body destroy-on-close>
      ...
      <el-table :data="fieldsListOfListener" max-height="240" border fit>
        <el-table-column label="序号" width="100px" type="index" />
        <el-table-column label="字段名称" min-width="100px" prop="name" />
        <el-table-column label="字段类型" min-width="100px" show-overflow-tooltip :formatter="row => fieldTypeObject[row.fieldType]" />
        <el-table-column label="字段值/表达式" min-width="120px" show-overflow-tooltip :formatter="row => row.string || row.expression" />
