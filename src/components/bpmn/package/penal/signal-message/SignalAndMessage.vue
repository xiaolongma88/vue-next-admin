  ...
  <div class="panel-tab__content">
    <div class="panel-tab__content--title">
      ...
      <el-button type="primary"
        :icon="Plus"
        @click="openModel('message')">创建新消息</el-button>
    </div>
    ...
    <div class="panel-tab__content--title"
      ...
      <el-button type="primary"
        :icon="Plus"
        @click="openModel('signal')">创建新信号</el-button>
    </div>
    ...
    <el-dialog v-model="modelVisible"
      :title="modelConfig.title"
      :close-on-click-modal="false"
      width="400px"
      append-to-body
      destroy-on-close>
      <el-form :model="modelObjectForm"
        label-width="100px"
        @submit.prevent>
        <el-form-item :label="modelConfig.idLabel">
          <el-input v-model="modelObjectForm.id"
            clearable />
        </el-form-item>
        <el-form-item :label="modelConfig.nameLabel">
          <el-input v-model="modelObjectForm.name"
            clearable />
        </el-form-item>
      </el-form>
      <template v-slot:footer>
        ...
        <el-button type="primary"
          @click="addNewObject">保 存</el-button>
      </template>
    </el-dialog>
  </div>
</template>
